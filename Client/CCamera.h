...
public:
	...
	void CamEffect(CAM_EFFECT _Effect_Type, float _fDuration)
	{
		tCamEffect ef = {};
		ef.eEffect = _Effect_Type;
		...
		if (0.f == _fDuration)
			assert(nullptr && "카메라 효과를 진행시킬 _fDuration의 값이 0입니다.");
	}
